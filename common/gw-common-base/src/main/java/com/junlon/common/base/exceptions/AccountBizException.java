...
public class AccountBizException extends BizException {
	...
	public static final AccountBizException ACCOUNT_CANOUT_AMOUNT_NOT_ENOUGH = new AccountBizException(20080125, "备付金账户可出款金额不足");

	public static final AccountBizException ACCOUNT_SETT_PARAM_ERROR = new AccountBizException(20170726, "结算参数错误");
	
	public static final AccountBizException ACCOUNT_ORDER_CREATE_FAIL = new AccountBizException(20170727, "订单创建失败");

	public static final AccountBizException ACCOUNT_RISK_AMOUNT_NOT_ENOUGH = new AccountBizException(20170729, "风控冻结资金不足");
	
	public static final AccountBizException ACCOUNT_CLEAR_FAIL = new AccountBizException(20171026, "账务清算发生异常");
	
	public static final AccountBizException ACCOUNT_AMOUNT_LESS_THAN_ZERO = new AccountBizException(20171027, "操作金额不能小于0");

	public static final AccountBizException UNEXPECT_ACCOUNT_TRADE_TYPE = new AccountBizException(2017120601, "未预期的交易类型");

	public static final AccountBizException DEBIT_FROZEN_RECORD_NOT_EXIST = new AccountBizException(2017121801, "出款冻结记录不存在");

	/**
	 * 可结算金额不足够出款
	 */
	public static final AccountBizException ACCOUNT_AVAILABLE_SETT_AMOUNT_NOT_ENOUGH = new AccountBizException(2017103100, "可结算金额不足");

	/**
	 * 可结算金额不足够出款
	 */
	public static final AccountBizException SETTLE_AMOUNT_NOT_ENOUGH = new AccountBizException(2017103101,"可取金额不足够出款");

	/**
	 * 可垫资金额不足够出款
	 */
	public static final AccountBizException ADVANCE_AMOUNT_NOT_ENOUGH = new AccountBizException(2017103102,"可垫资金额不足够出款");

	/**
	 * 可结金额、可垫金额分别不足够
	 */
	public static final AccountBizException SETTLE_AND_ADVANCE_AMOUNT_NOT_ENOUGH = new AccountBizException(2017103103,"可取金额、可垫金额分别不足够出款");

	/**
	 * 垫资金额计算错误
	 */
	public static final AccountBizException ADVANCE_AMOUNT_CALC_ERROR = new AccountBizException(2017103104, "垫资金额计算错误");

	/**
	 * 数据迁移的记录数不一致
	 */
	public static final AccountBizException MIGRATION_COUNT_NOT_EQUAL = new AccountBizException(2018010101, "数据迁移的记录数不一致");
	...
	public AccountBizException print(String message) {
